 ...
 <form name="myform" method="post" onsubmit="return formValidate(this);">
	...
	<select name="last_email_check2" onChange="email_input(this);" class="pass" id="last_email_check2" >
		...
		<option value="yahoo.com" >yahoo.com</option>
				...
				<p style="text-align:center; margin-bottom:20px"><a href="join02.jsp" ><input id="submit" type="image" src="../images/btn01.gif" /></a>&nbsp;&nbsp;<a href="#"><input id="reset" type="image" src="../images/btn02.gif" />
				</a></p>
